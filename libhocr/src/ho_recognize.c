...
ho_recognize_font_minus (const double *array_in)
{
  ...
  if (
       ...
       array_in[1] < 0.60 && array_in[1] > 0.20 && array_in[8] < 0.8 &&
       /* bars */
       /* edges */
       /* notches */
       /* ends */
...
ho_recognize_font_tag (const double *array_in)
{
  ...
  if (
       ...
       (array_in[46] > 0.5 || array_in[45] > 0.5) &&
       /* crosses */
...
ho_recognize_font_alef (const double *array_in)
{
  ...
  if (
       ...
       /* ends */
       array_in[41] > 0.5 && array_in[45] > 0.5 && array_in[47] > 0.5 &&
       /* crosses */
       array_in[52] > 0.5 &&
       /* holes */
       array_in[57] < 0.5 && array_in[59] < 0.5)
...
ho_recognize_font_bet (const double *array_in)
{
  ...
  if (
       ...
       /* notches */
       /* ends */
       array_in[39] > 0.5 && array_in[45] > 0.5 &&
       /* crosses */
       /* holes */
       array_in[57] < 0.5 && array_in[58] < 0.5 && array_in[59] < 0.5)
    return_value = 1.0;
...
ho_recognize_font_gimal (const double *array_in)
{
  ...
  if (
       ...
       array_in[45] > 0.5 && (array_in[39] > 0.5 || array_in[40] > 0.5) &&
       /* crosses */
       /* holes */
       array_in[57] < 0.5 && array_in[59] < 0.5)
    return_value = 1.0;
...
ho_recognize_font_hey (const double *array_in)
{
  ...
  if (
       ...
       /* notches */
       /* ends */
       array_in[39] > 0.5 && array_in[45] > 0.5 && array_in[47] > 0.5 &&
       /* crosses */
...
ho_recognize_font_vav (const double *array_in)
{
  ...
  if (
       ...
       array_in[3] < 0.55 && array_in[3] > 0.45 &&
       array_in[4] < 0.58 && array_in[4] >= 0.50 && array_in[7] > 0.5 &&
       /* bars */
       array_in[12] > 0.5 && array_in[10] < 0.5 &&
       /* edges */
       array_in[83] < 0.5 &&
       /* notches */
       /* ends */
...
ho_recognize_font_tet (const double *array_in)
{
  ...
  if (
       ...
       /* edges */
       array_in[24] < 0.5 && array_in[26] < 0.5 && array_in[82] < 0.5 &&
       array_in[86] > 0.5 && (array_in[87] > 0.5 || array_in[88] > 0.5) &&
       /* notches */
       /* ends */
       array_in[39] > 0.5 && array_in[46] < 0.5 && array_in[47] < 0.5 &&
       /* crosses */
       array_in[52] < 0.5 && array_in[55] < 0.5 &&
       /* holes */
       array_in[57] < 0.5 && array_in[59] < 0.5)
...
ho_recognize_font_yud (const double *array_in)
{
  ...
  if (
       /* dimentions */
       array_in[0] < 0.31 && array_in[0] > 0.18 &&
       array_in[1] < 0.26 && array_in[1] > 0.12 &&
       array_in[3] < 0.58 && array_in[3] > 0.42 &&
       array_in[4] < 0.85 && array_in[4] > 0.45 && array_in[7] > 0.5 &&
       /* bars */
       array_in[9] > 0.5 && array_in[10] < 0.5 &&
       array_in[11] < 0.5 && array_in[12] > 0.5 &&
...
ho_recognize_font_caf_sofit (const double *array_in)
{
  ...
  if (
       ...
       array_in[1] < 0.60 && array_in[1] > 0.30 &&
       array_in[3] < 0.55 && array_in[3] > 0.45 &&
       array_in[4] < 0.50 && array_in[4] > 0.15 && array_in[7] > 0.45 &&
       /* bars */
       array_in[9] > 0.5 && array_in[10] < 0.5 &&
       /* edges */
       array_in[80] > 0.5 &&
...
ho_recognize_font_nun_sofit (const double *array_in)
{
  ...
  if (
       ...
       array_in[1] < 0.33 && array_in[1] > 0.05 &&
       array_in[3] < 0.55 && array_in[3] > 0.45 &&
       array_in[4] < 0.50 && array_in[4] > 0.15 && array_in[7] > 0.5 &&
       /* bars */
       array_in[10] < 0.5 &&
       /* edges */
       array_in[82] < 0.5 &&
...
ho_recognize_font_kuf (const double *array_in)
{
  ...
  if (
       ...
       array_in[1] < 0.60 && array_in[1] > 0.30 &&
       array_in[3] < 0.60 && array_in[3] > 0.40 &&
       array_in[4] < 0.50 && array_in[4] > 0.20 &&
...
ho_recognize_font_shin (const double *array_in)
{
  ...
  if (
       ...
       /* edges */
       array_in[21] > 0.5 &&
       (array_in[22] > 0.5 || array_in[40] > 0.5 || array_in[49] > 0.5) &&
       array_in[23] > 0.5 &&
       /* notches */
       array_in[28] < 0.5 && array_in[37] < 0.5 &&
       (array_in[33] > 0.5 || array_in[34] > 0.5) &&
       (array_in[34] > 0.5 || array_in[35] > 0.5) &&
       /* ends */
